...
public class SystemInitialize {
	...
	public static void main(String argv[]) {
		...
		//Nous devons ajoute des nouveaus integer pour chaque nouveau signal
		
		new DeliveriesAlreadyAssignedToDriver(200, "DeliveriesAlreadyAssignedToDriverComponent");
		new DeliveriesUnassigned(201,"DeliveriesUnassignedComponent");
		//new DeliveryAlreadyAssigned(202,"DeliveryAlreadyAssignedComponent");
