...
public class Executive extends Communication {
	...
	public void execute() {
		...
		addToReceiverList("DeliveriesAlreadyAssignedToDriverComponent");
		
		//Modif 2
		
		addToReceiverList("DeliveriesUnassignedComponent");
		
		//Modif 3
		
		//addToReceiverList("DeliveryAlreadyAssignedComponent");
		
		//Modif 4
		//addToReceiverList("ConflictsComponent");
		...
		while (!done) {
			...
			case '6':
				signalReceivers("DeliveriesAlreadyAssignedToDriverComponent");
				break;
				
			case '7':
				signalReceivers("DeliveriesUnassignedComponent");
				break;
				
			case '8':
				signalReceivers("DeliveryAlreadyAssignedComponent");
				break;
